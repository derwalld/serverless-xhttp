...
// 环境变量
const UUID = process.env.UUID || 'b29d5bf8-2a27-4f92-a6f4-53d1558e6ee1'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezhatls.543083.xyz';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
